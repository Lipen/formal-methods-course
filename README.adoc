...
- M. Huth and M. Ryan, Logic in Computer Science: Modelling and Reasoning about Systems, 2nd ed. USA: Cambridge University Press, 2004.
...
- E. C. R. Hehner, link:https://www.cs.toronto.edu/~hehner/aPToP/[a Practical Theory of Programming]. Toronto, Canada: Electronic textbook, 2025.
